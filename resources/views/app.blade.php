            ...
            <div class="list-group panel">
                <ul class="nav navbar-nav">
                    ...
                    <div class="collapse" id="demo3">
                        ...
                        <a href="{{ URL::to('plantillas/despido') }}" class="list-group-item" data-parent="#SubMenu1">Despido <i class="fa fa-caret-down"></i></a>
                        <a href="{{ URL::to('plantillas/sancion') }}" class="list-group-item" data-parent="#SubMenu1">Sancion <i class="fa fa-caret-down"></i></a>                                                          
                        <a href="{{ URL::to('plantillas/invitacion') }}" class="list-group-item" data-parent="#SubMenu1">Invitacion <i class="fa fa-caret-down"></i></a>                                                          
                        <a href="{{ URL::to('plantillas/ausencia_de_trabajo') }}" class="list-group-item" data-parent="#SubMenu1">Ausencia de Trabajo <i class="fa fa-caret-down"></i></a>                                                          
                    </div>
